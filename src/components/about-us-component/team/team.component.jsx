        ...
        <MDBCardBody>
          ...
          <MDBRow>
            <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
              ...
              <p className="text-uppercase font-weight-bold grey-text">
                Founder
              </p>
              <ul className="list-unstyled mb-0">
                <a
                  href="https://slack-redir.net/link?url=https%3A%2F%2Fwww.facebook.com%2Filesanmi.olalekan1"
                  className="p-2 fa-lg"
                >
                ...
                <a
                  href="https://slack-redir.net/link?url=https%3A%2F%2Fwww.linkedin.com%2Fin%2Folalekan-ilesanmi-95766756"
                  className="p-2 fa-lg"
                >
            ...
            <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
              ...
              <ul className="list-unstyled mb-0">
                <a
                  href="https://www.facebook.com/abasifreke.ekwere"
                  className="p-2 fa-lg"
                >
                  <MDBIcon fab icon="facebook-f" className="blue-text" />
                </a>
                <a
                  href="https://www.twitter.com/KingAbesh_"
                  className="p-2 fa-lg"
                >
                  <MDBIcon fab icon="twitter" className="blue-text" />
                </a>
                <a
                  href="www.linkedin.com/in/abasifreke-ekwere-743b42154"
                  className="p-2 fa-lg"
                >
                  <MDBIcon fab icon="linkedin" className="blue-text" />
                </a>
                <a
                  href="https://www.github.com/KingAbesh"
                  className="p-2 fa-lg"
                >
            ...
            <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
              ...
              <ul className="list-unstyled mb-0">
                ...
                <a
                  href="https://www.linkedin.com/in/lasisi-sodiq-301791160/"
                  className="p-2 fa-lg"
                >
                  <MDBIcon fab icon="linkedin" className="blue-text" />
                </a>
                <a
                  href="https://slack-redir.net/link?url=https%3A%2F%2Fwww.instagram.com%2Flvzylass%2F"
                  className="p-2 fa-lg"
                >
                  <MDBIcon fab icon="instagram" className="blue-text" />
                </a>
                <a
                  href="https://www.behance.net/sodiqlasisi"
                  className="p-2 fa-lg"
                >
            ...
            <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
              ...
              <ul className="list-unstyled mb-0">
                ...
                <a
                  href="https://www.instagram.com/peacejeorgejustce/?hl=en"
                  className="p-2 fa-lg"
                >
                  <MDBIcon fab icon="instagram" className="blue-text" />
                </a>
